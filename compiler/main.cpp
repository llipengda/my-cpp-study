...
const lexer::lexer::input_keywords_t<token_type> keywords = {
    {regex::regex("int"), token_type::INT, "int"},
    {regex::regex("real"), token_type::REAL, "real"},
    {regex::regex("if"), token_type::IF, "if"},
    {regex::regex("then"), token_type::THEN, "then"},
    {regex::regex("else"), token_type::ELSE, "else"},
    {regex::regex("\\("), token_type::LPAR, "("},
    {regex::regex("\\)"), token_type::RPAR, ")"},
    {regex::regex(";"), token_type::SEMI, ";"},
    {regex::regex("{"), token_type::LBRACE, "{"},
    {regex::regex("}"), token_type::RBRACE, "}"},
    {regex::regex("\\+"), token_type::PLUS, "+"},
    {regex::regex("-"), token_type::MINUS, "-"},
    {regex::regex("\\*"), token_type::MULT, "*"},
    {regex::regex("/"), token_type::DIV, "/"},
    {regex::regex("<"), token_type::LT, "<"},
    {regex::regex("<="), token_type::LE, "<="},
    {regex::regex(">"), token_type::GT, ">"},
    {regex::regex(">="), token_type::GE, ">="},
    {regex::regex("=="), token_type::EQ, "=="},
    {regex::regex("="), token_type::ASSIGN, " ="},
    {regex::regex("[a-zA-Z_][a-zA-Z0-9_]*"), token_type::ID, "ID"},
    {regex::regex("[0-9]+"), token_type::INTNUM, "INTNUM"},
    {regex::regex("[0-9]+.[0-9]*"), token_type::REALNUM, "REALNUM"},

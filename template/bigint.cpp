...
public:
    ...
    BigInt(const std::vector<int> v, int f = 1) : v(v), f(f) { vector_to_string(); } // HINT v must be reversed
    BigInt(const BigInt& other) : v(other.v), f(other.f), s(other.s) {}
    BigInt& operator=(BigInt& other);
    BigInt& operator=(std::string& other);
...
BigInt& BigInt::operator=(std::string& other) {
    BigInt n(other);
    *this = n;
    return *this;
}
